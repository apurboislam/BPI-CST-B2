...
$routine = [
    ...
    "Thu" => [
        "1st" => ["subject" => "Basic Electricity-1", "teacher" => "ECL", "room" => ""],
        "2nd" => ["subject" => "Basic Electricity-1", "teacher" => "ECL", "room" => ""],
        "3rd" => ["subject" => "Basic Electricity-1", "teacher" => "ECL", "room" => ""],
        "4th" => ["subject" => "Physics-1", "teacher" => "Md Sultan Mahmud", "room" => "338"],
        "5th" => ["subject" => "Bangla-1", "teacher" => "Ruhul Amin Rajib", "room" => "338"],
